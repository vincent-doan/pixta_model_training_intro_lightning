...
class ResNet50LightningModule(L.LightningModule):
    def __init__(self, hidden_size:int, output_size:int, transfer:bool, optimizer_config:dict, loss_fn):
        ...
        self.train_prec = MulticlassPrecision(num_classes=output_size, average='weighted')
        self.train_rec = MulticlassRecall(num_classes=output_size, average='weighted')
        self.train_f1 = MulticlassF1Score(num_classes=output_size, average='weighted')
        self.train_metrics = {
        ...
        self.val_prec = MulticlassPrecision(num_classes=output_size, average='weighted')
        self.val_rec = MulticlassRecall(num_classes=output_size, average='weighted')
